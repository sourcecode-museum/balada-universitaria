...
String vFormAction = "admin_promocoes.jsp";
int vCodEstab=0; 
int vCodEvent=0; 
String sCodEvent=""; 
String vNmEvent=""; 
...
<div class="panel">
	...
	<fieldset>
	<legend class="negrito">Promoções</legend>
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr class="borderbottom">			
			<td class="coluna">Nome Promoção:</td>
